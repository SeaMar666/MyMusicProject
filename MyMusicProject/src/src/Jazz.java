...
public class Jazz extends javax.swing.JFrame{
    JPanel jazzPanel;
    private JComboBox jazzComboBox;
    ...
    {
        try {
            String query = "select Type,Artist,Song from  project2.mymusic where Type=\"Jazz\"";
        ...
        deleteButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int index = jazzComboBox.getSelectedIndex();
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("username nerde AQ" + username);
                Statement st = null;
                try {
